-- 23.	Realizar un algoritmo que permita ingresar los siguientes datos de los empleados de 
--una empresa: apellido, nombre, edad, sueldo. 
-- Se solicita obtener el promedio de ingresos de los empleados cuyas edades estén comprendidas  
--entre 30 y 50 años. 
-- Se finaliza el ingreso de datos cuando el apellido sea igual a “FIN”.
